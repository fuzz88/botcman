from workflows.utils import get_user_data_from_api, save_user_to_db, check_user_in_db
from data.loader import load

def init(bot):
    @bot.command(r"/start")
    async def greet_and_save_new_user(chat, match):
        await chat.send_text(load("./data/messages/on_start.md"), **{"parse_mode": "MarkdownV2"})
